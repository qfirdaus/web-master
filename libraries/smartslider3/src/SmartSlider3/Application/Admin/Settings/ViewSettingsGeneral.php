...
class ViewSettingsGeneral extends AbstractViewSettings {
    ...
    public function renderForm() {
        ...
        new OnOff($row3, 'lightbox-mobile-new-tab', n2_('Lightbox videos in new tab on Mobile/Tablet'), 1, array(
            'tipLabel'       => n2_('Lightbox videos in new tab on Mobile/Tablet'),
            'tipDescription' => n2_('Opens lightbox videos in their app to avoid the mobile or tablet disabling the video.'),
