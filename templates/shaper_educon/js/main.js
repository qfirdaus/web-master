...
jQuery(function ($) {
    ...
    // Facilities directory search fallback.
    var $facilitySearch = $('#section-id-26b79856-f226-473a-9ec0-ddf18afdf9b0 .sppb-addon-table-search');
    if ($facilitySearch.length) {
        $facilitySearch.attr('placeholder', 'Cari kemudahan...');
        $facilitySearch.on('input', function () {
            var keyword = $(this).val().toLowerCase().trim();
            var $rows = $('#section-id-26b79856-f226-473a-9ec0-ddf18afdf9b0 .sppb-addon-table-main tbody tr');
