...
<div class="splms view-splms-courses mod-splms-courses <?php echo $moduleclass_sfx; ?>">
                ...
                <div class="splms-course splms-match-height">
                    ...
                    <div class="splms-course-info">
                        ...
                        <div class="splms-course-meta">
                            ...
                            <?php echo JText::_('SPLMS_COURSE_LESSONS'); ?>
                            <?php echo ' . '; ?>
                            <?php echo count($total_attachments); ?>
                            <?php echo JText::_('SPLMS_COURSE_ATTACHMENTS'); ?>
                        </div>
                        <div class="course-details-btn">
                            <a href="<?php echo $course_item->url; ?>" class="splms-readmore btn btn-primary">
