...
<?php if (
	$this->item->state == 0 || strtotime(!empty($this->item->publish_up) ? $this->item->publish_up : '') > strtotime(Factory::getDate())
	...
	if ($post_format == 'standard') {
		echo LayoutHelper::render('joomla.content.intro_image_blog', array('item' => $this->item, 'size' => 'medium'));
	} else {
	...
	<div class="content-wrap">
		...
		<?php if ($params->get('show_publish_date')) : ?>
			<?php echo LayoutHelper::render('joomla.content.info_block.publish_date', array('item' => $this->item, 'params' => $params)); ?>
		<?php endif; ?>
		<!-- //publish_date -->
