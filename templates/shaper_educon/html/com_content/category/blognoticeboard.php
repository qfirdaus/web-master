...
?>
<div class="educon-notice-board blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Blog">
	...
	$counter = 0;
	if (JVERSION >= 4) {$this->columns = $this->params->get('num_columns', 1);}
	?>
...
<!-- NOTICE BOARD ADD -->
<?php if ( $doc->countModules('notice-board-add') ) { ?>
	<div class="educon-add notice-board-add items-row row clearfix">
		<div class="col-sm-12">
		<?php
			jimport( 'joomla.application.module.helper' );
			$modules = JModuleHelper::getModules( 'notice-board-add' );
