...
?>
<div class="blog<?php echo $this->pageclass_sfx; ?> blog-grid-view" itemscope itemtype="http://schema.org/Blog">
	...
	<?php if (!empty($this->lead_items)) : ?>
		<div class="items-leading clearfix">
			<?php foreach ($this->lead_items as $key=> &$item) : ?>
				...
				<?php $totalItemNo++; $leadingcount++; ?>

				<!-- if item has 3 then module position will be set -->
				<?php if ( ($totalItemNo == ( $tpl_params->get('blog_list_add', 3) ) ) && $doc->countModules('blog-list-add') ) { ?>
					<div class="educon-add items-row row clearfix">
						<div class="col-sm-12">
						<?php
							jimport( 'joomla.application.module.helper' );
							$modules = JModuleHelper::getModules( 'blog-list-add' );
