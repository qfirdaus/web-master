    ...
    <div class="splms-course-info">
        <h3 class="splms-courses-title">
            <a href="<?php echo $course->url; ?>">
                <small><i class="fa fa-folder-o"></i><?php echo $course->category_name; ?></small>
        ...
        <div class="course-details-btn">
            <a href="<?php echo $course->url; ?>" class="splms-readmore btn btn-default">
                <?php echo $params->get('readmore_text', Text::_('COM_SPLMS_DETAILS')) , '<i class="fa fa-angle-right"></i>'; ?>
            </a>
        </div>
</div>
</div>