...
if (is_array($displayData)) {
	...
	$layout_img_size = $displayData['size'];
	$displayData_item = $displayData['item'];
} else {
...
$imgsize 		= ($layout_img_size) ? $layout_img_size : $tplParams->get('blog_list_image', 'default');
//$imgsize 		= 'medium';
...
<div class="entry-image intro-image">
	<?php if ($params->get('link_titles') && $params->get('access-view')) { ?>
		<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData_item->slug, $displayData_item->catid, $displayData_item->language)); ?>">
	<?php } ?>
