...
//Class Classes
$body_classes = '';
if ($menu && $menu->menutype === 'fakultiupnm-bm') {
	$body_classes .= ' site-mode-faculty';
} elseif ($menu && $menu->menutype === 'ptmk-bm') {
	$body_classes .= ' site-mode-department';
}
...
<body class="<?php echo $helix3->bodyClass($body_classes); ?>">
    ...
    <div class="offcanvas-menu">
        <a href="#" class="close-offcanvas" aria-label="Close"><i class="fa fa-remove" aria-hidden="true"
                title="<?php echo JText::_('HELIX_CLOSE_MENU'); ?>"></i></a>
