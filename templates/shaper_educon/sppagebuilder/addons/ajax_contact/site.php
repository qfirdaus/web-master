...
class SppagebuilderAddonAjax_contact extends SppagebuilderAddons
{
	...
	public function render()
	{
		...
		if ($use_custom_button) {
			$button_text = (isset($this->addon->settings->button_text) && $this->addon->settings->button_text) ? $this->addon->settings->button_text : Text::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SEND');
