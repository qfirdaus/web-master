	...
	array(
		...
		'attr' => array(
			'general' => array(
				...
				'syntax' => array(
					'type' => 'text',
					'title' => JText::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_NUMBER_SYNTAX'),
					'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_NUMBER_SYNTAX_DESC'),
					'placeholder' => '%',
					'std' => '',
				),
				...
				'counter_title_alignment' => array(
					'type' => 'select',
					'title' => JText::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_NUMBER_TITLE_ALIGNMENT'),
					'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_NUMBER_TITLE_ALIGNMENT_DESC'),
					'values' => array(
						'before' => JText::_('COM_SPPAGEBUILDER_GLOBAL_BEFORE'),
						'after' => JText::_('COM_SPPAGEBUILDER_GLOBAL_AFTER'),
					),
					'std' => 'before',
				),
