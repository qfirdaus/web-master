...
?>
<!DOCTYPE html>
<html class="sp-comingsoon" xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>"
...
<head>
	...
	$helix3->addCSS('bootstrap.min.css, joomla-fontawesome.min.css, font-awesome-v4-shims.min.css')
		->lessInit()->setLessVariables(array(
			...
			'hover_color' => $helix3->PresetParam('_hover'),
...
<body>
    <div class="sp-comingsoon-wrap <?php echo $hascs_bg; ?>"
        style="background-image: url(<?php echo $comingsoon_bg; ?>);">
        <div class="container">
            <div class="text-center">
                <div id="sp-comingsoon">
                    ...
                    <ul class="social-icons">
                        <?php if ($facebook) : ?>
                        <li><a target="_blank" href="<?php echo $facebook; ?>"><i class="fa fa-facebook"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($twitter) : ?>
                        <li><a target="_blank" href="<?php echo $twitter; ?>"><i class="fa fa-twitter"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($pinterest) : ?>
                        <li><a target="_blank" href="<?php echo $pinterest; ?>"><i class="fa fa-pinterest"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($youtube) : ?>
                        <li><a target="_blank" href="<?php echo $youtube; ?>"><i class="fa fa-youtube"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($linkedin) : ?>
                        <li><a target="_blank" href="<?php echo $linkedin; ?>"><i class="fa fa-linkedin"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($dribbble) : ?>
                        <li><a target="_blank" href="<?php echo $dribbble; ?>"><i class="fa fa-dribbble"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($behance) : ?>
                        <li><a target="_blank" href="<?php echo $behance; ?>"><i class="fa fa-behance"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($flickr) : ?>
                        <li><a target="_blank" href="<?php echo $flickr; ?>"><i class="fa fa-flickr"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>

                        <?php if ($vk) : ?>
                        <li><a target="_blank" href="<?php echo $vk; ?>"><i class="fa fa-vk" area-hidden="true"></i></a>
                        </li>
                        <?php endif; ?>

                        <?php if ($skype) : ?>
                        <li><a href="skype:<?php echo $skype; ?>'?chat"><i class="fa fa-skype"
                                    area-hidden="true"></i></a></li>
                        <?php endif; ?>
                        <ul>
                            <?php endif; ?>
