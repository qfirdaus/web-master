...
class DJImageSliderViewItem extends HtmlView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$text = $isNew ? Text::_( 'COM_DJIMAGESLIDER_NEW' ) : Text::_( 'COM_DJIMAGESLIDER_EDIT' );
		ToolBarHelper::title(   Text::_( 'COM_DJIMAGESLIDER_ITEM' ).': <small><small>[ ' . $text.' ]</small></small>', 'generic.png' );
