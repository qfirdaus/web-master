...
class DJImageSliderModelItem extends AdminModel
{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_djimageslider.edit.item.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if(empty($table->publish_down)) {
			$table->publish_down = Factory::getDbo()->getNullDate();
		}
