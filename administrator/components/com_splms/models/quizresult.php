...
class SplmsModelQuizresult extends AdminModel {
	/**
	...
	*/
	...
	public function getTable($type = 'Quizresult', $prefix = 'SplmsTable', $config = array()) {
	...
	*/
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm('com_splms.quizresult', 'quizresult', array( 'control' => 'jform', 'load_data' => $loadData ) );
		if (empty($form)) {
			return false;
		}
	...
	*/
	protected function loadFormData() {
		...
		$data = Factory::getApplication()->getUserState( 'com_splms.edit.quizresult.data', array() );
	...
	*/
	protected function canDelete($record) {
		if (!empty($record->id)) {
			...
			return Factory::getUser()->authorise('core.delete', 'com_splms.quizresult.' . (int) $record->id);
		}
