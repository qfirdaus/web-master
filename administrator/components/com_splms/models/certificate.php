...
class SplmsModelCertificate extends AdminModel {
	/**
	...
	*/
	...
	public function getTable($type = 'Certificate', $prefix = 'SplmsTable', $config = array()) {
	...
	*/
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm('com_splms.certificate', 'certificate', array( 'control' => 'jform', 'load_data' => $loadData ) );
	...
	*/
	protected function canDelete($record) {
		if (!empty($record->id)) {
			...
			return Factory::getUser()->authorise('core.delete', 'com_splms.certificate.' . (int) $record->id);
		}
