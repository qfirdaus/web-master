...
class SplmsModelOrder extends AdminModel {
	...
	*/
	...
	public function getTable($type = 'Order', $prefix = 'SplmsTable', $config = array()) {
	...
	*/
	...
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm('com_splms.order', 'order', array( 'control' => 'jform', 'load_data' => $loadData ) );
	...
	*/
	protected function loadFormData() {
		...
		$data = Factory::getApplication()->getUserState( 'com_splms.edit.order.data', array() );
	...
	*/
	protected function canDelete($record) {
		if (!empty($record->id)) {
			...
			return Factory::getUser()->authorise('core.delete', 'com_splms.order.' . (int) $record->id);
		}
