...
class SplmsModelSpeaker extends AdminModel {
	/**
	...
	*/
	...
	public function getTable($type = 'Speaker', $prefix = 'SplmsTable', $config = array()) {
	...
	*/
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm('com_splms.speaker', 'speaker', array( 'control' => 'jform', 'load_data' => $loadData ) );
	...
	*/
	protected function loadFormData() {
		...
		$data = Factory::getApplication()->getUserState( 'com_splms.edit.speaker.data', array() );
	...
	*/
	protected function canDelete($record) {
		if (!empty($record->id)) {
			...
			return Factory::getUser()->authorise('core.delete', 'com_splms.speaker.' . (int) $record->id);
		}
