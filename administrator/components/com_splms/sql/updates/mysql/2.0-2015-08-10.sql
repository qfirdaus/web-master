...
-- -- ALTER TABLES;
-- ALTER TABLE `#__splms_courses` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_coursescategories` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_eventcategories` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_events` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_lessons` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_speakers` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
-- ALTER TABLE `#__splms_teachers` CHANGE `slug` `alias` VARCHAR(50) NOT NULL DEFAULT '';
