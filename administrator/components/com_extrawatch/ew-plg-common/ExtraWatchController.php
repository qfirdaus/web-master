...
#require_once("./ExtraWatchCMSSpecific.php");
require_once JPATH_ADMINISTRATOR . '/components/com_extrawatch/ew-plg-common/ExtraWatchRenderer.php' ;
...
class ExtraWatchController {
    ...
    private $extraWatchTempLogin;
    private $extraWatchProject;
		private $extraWatchSettings;
		private $extraWatchPreReq;
