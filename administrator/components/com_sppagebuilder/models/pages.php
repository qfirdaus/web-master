...
class SppagebuilderModelPages extends ListModel
{
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				'id', 'a.id',
				'title', 'a.title',
				'extension_view', 'a.extension_view',
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.checked_out, a.checked_out_time, a.text, a.created_by, a.extension_view,' .
					'a.published, a.access, a.catid, a.ordering, a.created_on, a.created_by, a.language, a.hits, a.version'
			)
		);
		...
		$query->where($db->quoteName('a.extension_view') . ' <> ' . $db->quote('dynamic_content:detail'));
