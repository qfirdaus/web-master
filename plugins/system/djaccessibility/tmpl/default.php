...
<section class="djacc djacc-container djacc-popup djacc--hidden<?php echo $style . $align; ?>">
    ...
    <div class="djacc__panel">
        <div class="djacc__header">
            <div class="djacc__title"><?php echo Text::_('PLG_DJACCESSIBILITY_TITLE'); ?></div>
        ...
        <ul class="djacc__list">
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--invert-colors" title="<?php echo Text::_('PLG_DJACCESSIBILITY_INVERT_COLORS_TITLE'); ?>">
            ...
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--monochrome" title="<?php echo Text::_('PLG_DJACCESSIBILITY_MONOCHROME_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="#fff" stroke-width="2">
                            <circle cx="12" cy="12" r="12" stroke="none"/>
                            <circle cx="12" cy="12" r="11" fill="none"/>
            ...
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--dark-contrast" title="<?php echo Text::_('PLG_DJACCESSIBILITY_DARK_CONTRAST_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--light-contrast" title="<?php echo Text::_('PLG_DJACCESSIBILITY_LIGHT_CONTRAST_TITLE'); ?>">
            ...
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--low-saturation" title="<?php echo Text::_('PLG_DJACCESSIBILITY_LOW_SATURATION_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="#fff" stroke-width="2">
                            <circle cx="12" cy="12" r="12" stroke="none"/>
                            <circle cx="12" cy="12" r="11" fill="none"/>
            ...
            <li class="djacc__item djacc__item--contrast">
                <button class="djacc__btn djacc__btn--high-saturation" title="<?php echo Text::_('PLG_DJACCESSIBILITY_HIGH_SATURATION_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="#fff" stroke-width="2">
                            <circle cx="12" cy="12" r="12" stroke="none"/>
                            <circle cx="12" cy="12" r="11" fill="none"/>
            ...
            <li class="djacc__item">
                <button class="djacc__btn djacc__btn--highlight-links" title="<?php echo Text::_('PLG_DJACCESSIBILITY_HIGHLIGHT_LINKS_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <li class="djacc__item">
                <button class="djacc__btn djacc__btn--highlight-titles" title="<?php echo Text::_('PLG_DJACCESSIBILITY_HIGHLIGHT_TITLES_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <li class="djacc__item">
                <button class="djacc__btn djacc__btn--screen-reader" title="<?php echo Text::_('PLG_DJACCESSIBILITY_SCREEN_READER_TITLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="#fff" stroke-width="2">
                            <circle cx="12" cy="12" r="12" stroke="none"/>
                            <circle cx="12" cy="12" r="11" fill="none"/>
            ...
            <li class="djacc__item">
                <button class="djacc__btn djacc__btn--read-mode" title="<?php echo Text::_('PLG_DJACCESSIBILITY_READ_MODE_TITLE'); ?>" data-label="<?php echo Text::_('PLG_DJACCESSIBILITY_READ_MODE_DISABLE'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="#fff" stroke-width="2">
                            <rect width="24" height="24" rx="4" stroke="none"/>
                            <rect x="1" y="1" width="22" height="22" rx="3" fill="none"/>
            ...
            <li class="djacc__item djacc__item--full">
				<span class="djacc__arrows djacc__arrows--zoom">
					...
					<button class="djacc__dec" aria-label="<?php echo Text::_('PLG_DJACCESSIBILITY_ZOOM_DEC_TITLE'); ?>" title="<?php echo Text::_('PLG_DJACCESSIBILITY_ZOOM_DEC'); ?>">
