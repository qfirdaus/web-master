 ...
 * @since  11.1
 */
class JFormFieldDJFolderList extends ListField
{
	/**
	 * The form field type.
	 *
	...
	protected function getOptions()
	{
		...
		$path = Path::clean($this->directory);
		...
		if (is_array($folders))
		{
			foreach ($folders as $folder)
			{
				...
				$folder_name = ( $folder == 'classic' ) ? $folder . ' (deprecated)' : $folder;

				$options[] = HTMLHelper::_('select.option', $folder, $folder_name);
			}
		}
