...
if (is_array($cate_filters)) {
    ...
    $cate_filters = ($cate_filters) ? explode(',', $cate_filters) : NULL;
    $cate_filters = ArrayHelper::toInteger($cate_filters);
}

// Filter by levels
$level_filters  = $input->get('level', NULL, 'STRING');
$level_filters  = ($level_filters) ? explode(',', $level_filters) : NULL;
...
<div class="splms-col-md-3<?php echo ($position == 'right') ? ' splms-col-md-push-9' : ''; ?>">
    <aside class="splms-sidebar">
        <h3 class="sidebar-title"><?php echo Text::_('COM_SPLMS_FILTERS_TITLE'); ?></h3>
