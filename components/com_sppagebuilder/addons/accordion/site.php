...
class SppagebuilderAddonAccordion extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		$activeImageStyle = $cssHelper->generateStyle('sppb-accordion-image', $settings, ['image_height' => 'height', 'image_width' => 'width'], false);
		$transformCss = $cssHelper->generateTransformStyle('.sppb-panel-custom', $settings, 'transform');
	...
	public static function getTemplate()
	{
		...
		$output .= $lodash->generateTransformCss('.sppb-panel-custom', 'data.transform');
