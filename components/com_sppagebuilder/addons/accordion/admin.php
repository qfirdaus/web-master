    ...
    'settings' => [
                ...
                'sp_accordion_item' => [
                    ...
                    'attr'  => [
                        ...
                        'visual_item_type' => [
                            ...
                            'std'    => 'icon',
                            'values' => [
                                ['label' => Text::_('COM_SPPAGEBUILDER_GLOBAL_ICON'), 'value' => 'icon'],
                                ['label' => Text::_('COM_SPPAGEBUILDER_GLOBAL_IMAGE'), 'value' => 'image']
                            ],
				        ],
        ...
        'header' => [
            ...
            'fields' => [
                ...
                'icon_position' => [
                    'type'   => 'radio',
                    'title'  => Text::_('COM_SPPAGEBUILDER_ADDON_MEDIA_POSITION'),
                    'values' => [
                ...
                'icon_fontsize' => [
                    'type'       => 'slider',
                    'title'      => Text::_('COM_SPPAGEBUILDER_ADDON_MEDIA_SIZE'),
                    'responsive' => true,
                    'max'        => 400,
                    'depends' => [['style', '=', 'panel-custom']],
                ],
                ...
                'icon_margin' => [
                    'type'        => 'margin',
                    'title'       => Text::_('COM_SPPAGEBUILDER_ADDON_MEDIA_MARGIN'),
                    'responsive'  => true,
                    'max'         => 400,
                    'depends' => [['style', '=', 'panel-custom']],
                ],
                ...
                'active_icon_rotate' => [
                    'type'    => 'slider',
                    'title'   => Text::_('COM_SPPAGEBUILDER_ADDON_MEDIA_ROTATION'), // active
                    'max'     => 360,
                    'info'    => 'deg',
                    'std'     => 0,
                    'depends' => [['style', '=', 'panel-custom']],
