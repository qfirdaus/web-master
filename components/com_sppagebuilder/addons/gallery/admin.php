			...
			'fields' => [
				'sp_gallery_item' => [
					...
					'attr'  => [
						...
						'description' => [
							'type'  => 'textarea',
							'title' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_DESCRIPTION'),
							'desc' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_DESCRIPTION_DESC'),
						],
					],
					'bulk_import' => true,
				],
				...
				'description_alignment' => [
                    'type' => 'buttons',
                    'title' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_DESCRIPTION_ALIGNMENT'),
                    'values' => [
                        ['label' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_TEXT_ALIGN_START'), 'value' => 'start'],
                        ['label' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_TEXT_ALIGN_CENTER'), 'value' => 'center'],
                        ['label' => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_TEXT_ALIGN_END'), 'value' => 'end'],
                    ],
                    'responsive' => true,
                    'std' => 'center',
                ],
				...
				'show_thumb_desc' => [
                    'type'    => 'checkbox',
                    'title'   => Text::_('COM_SPPAGEBUILDER_ADDON_GALLERY_THUMB_DESC'),
                    'std'     => 0,
                ],
