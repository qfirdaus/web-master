		...
		'carousel_options' => [
			...
			'fields' => [
				...
				'bullet_border_color' => [
					...
					'depends' => [['controls', '=', 1], ['tab_bullet', '=', 'normal']],
				],
				...
				'bullet_hover_border_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BORDER_COLOR'),
					'depends' => [['controls', '=', 1], ['tab_bullet', '=', 'hover']]
				],

				'bullet_hover_background_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND'),
					'depends' => [['controls', '=', 1], ['tab_bullet', '=', 'hover']]
				],
				...
				'arrow_color' => [
					...
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'std'     => '',
					'depends' => [['arrow_controls', '=', 1], ['tab_arrows', '=', 'normal']]
				],
				...
				'arrow_hover_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'depends' => [['arrow_controls', '=', 1], ['tab_arrows', '=', 'hover']]
				],
