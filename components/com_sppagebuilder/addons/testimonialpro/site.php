...
class SppagebuilderAddonTestimonialpro extends SppagebuilderAddons
{
    ...
    public function render()
    {
        ...
        {
            shuffle($settings->sp_testimonialpro_item);
        }
        ...
        foreach ($settings->sp_testimonialpro_item as $key => $value) {
            ...
            $alt_text = isset($avatar_img->alt) ? $avatar_img->alt : $name;

            if ($avatar_on_top == 1) {
                $output .= $carousel_img_src ? '<img src="' . $carousel_img_src . '" class="' . $avatar_shape . '" alt="' . $alt_text . '">' : '';
            }
    ...
    public function css()
    {
        ...
        $bulletActiveBorderStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li.active', $settings, ['bullet_active_bg_color' => 'border-color'], false);
        $bulletActiveHoverStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li.active:hover', $settings, ['bullet_active_bg_color' => 'background'], false);
        $bulletActiveBorderHoverStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li.active:hover', $settings, ['bullet_active_bg_color' => 'border-color'], false);
        $bulletNormalStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li', $settings, ['bullet_background_color' => 'background'], false);
        $bulletHoverStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li:hover', $settings, ['bullet_hover_background_color' => 'background', 'bullet_hover_border_color' => 'border-color'], false);
        $bulletBorderStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li', $settings, ['bullet_border_color' => 'border-color'], false);
        $bulletHoverBorderStyle = $cssHelper->generateStyle('.sppb-carousel-indicators li:hover', $settings, ['bullet_hover_border_color' => 'border-color'], false);


        //Transform Styles
        $transformCss = $cssHelper->generateTransformStyle('.sppb-testimonial-pro', $settings, 'transform');
        ...
        $css .= $bulletNormalStyle;
        $css .= $bulletHoverStyle;
        $css .= $bulletBorderStyle;
        $css .= $bulletHoverBorderStyle;
        $css .= $bulletActiveBorderStyle;
        $css .= $bulletActiveHoverStyle;
        $css .= $bulletActiveBorderHoverStyle;
    ...
    public static function getTemplate()
    {
        ...
        $output .= $lodash->border('border-color', '.sppb-carousel-indicators li:hover', 'data.bullet_hover_border_color');
        ...
        $output .= $lodash->color('background-color', '.sppb-carousel-indicators li', 'data.bullet_background_color');
        $output .= $lodash->color('background-color', '.sppb-carousel-indicators li:hover', 'data.bullet_hover_background_color');
        $output .= $lodash->border('border-color', '.sppb-carousel-indicators li.active:hover', 'data.bullet_active_bg_color');
        $output .= $lodash->color('background-color', '.sppb-carousel-indicators li.active:hover', 'data.bullet_active_bg_color');
        ...
        $output .= '
            ...
            <# if(data.randomize_carousel)
                {
					data.sp_testimonialpro_item = _.shuffle(data.sp_testimonialpro_item);
			    } #>
                ...
                <div class="sppb-carousel-inner">
                    ...
                    #>
                        ...
                        <div class="sppb-item{{ slideActClass }}">
                            ...
                            let alt_text = itemSlide?.avatar?.alt ?? itemSlide?.title;
                            ...
                            if (!_.isEmpty(avatarImg.src)) { #>
                                <# if(avatarImg.src.indexOf("https://") == -1 && avatarImg.src.indexOf("http://") == -1){ #>
                                    <img class="{{ avatar_shape }}" src=\'{{ pagebuilder_base + avatarImg.src }}\' alt="{{alt_text}}">
                                <# } else { #>
                                    <img class="{{ avatar_shape }}" src=\'{{ avatarImg.src }}\' alt="{{alt_text}}">
                                <# } #>
                            <# }
                            } #>
