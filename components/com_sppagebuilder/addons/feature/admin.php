...
SpAddonsConfig::addonConfig([
	...
	'settings' => [
		...
		'second_button_toggle' => [
			'title' => 'Active Second Button',
			'fields' => [
				'is_second_button' => [
					'title' => 'Active Second Button',
					'type' => 'checkbox',
		...
		'second_button' => [
			'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_SECOND_BUTTON'),
			'fields' => [
				'second_btn_text' => [
					'type'  => 'text',
					'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_LABEL'),
				...
				'second_btn_typography' => [
					'type'     => 'typography',
					'title'  => Text::_('COM_SPPAGEBUILDER_GLOBAL_TYPOGRAPHY'),
					'fallbacks' => [
						'font' => 'second_btn_font_family',
						'size' => 'second_btn_fontsize',
						'letter_spacing' => 'second_btn_letterspace',
						'weight' => 'second_btn_font_style.weight',
						'italic' => 'second_btn_font_style.italic',
						'underline' => 'second_btn_font_style.underline',
						'uppercase' => 'second_btn_font_style.uppercase',
					],
				],
				...
				'second_button_padding' => [
					...
					'responsive' => true,
					'std' => ['xl' => '8px 22px 10px 22px', 'lg' => '', 'md' => '', 'sm' => '', 'xs' => ''],
					'depends' => [['second_btn_size', '=', '']]
				],

				'second_btn_appearance' => [
					'type'   => 'select',
					'title'  => Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_APPEARANCE'),
					'desc'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_APPEARANCE_DESC'),
					'values' => [
				...
				'second_link_btn_padding_bottom' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_PADDING_BOTTOM'),
					'max'     => 100,
					'std'     => '',
				...
				'second_button_margin' => [
					...
					'title'       => Text::_('COM_SPPAGEBUILDER_GLOBAL_MARGIN'),
					'responsive'  => true,
					'std'         => ['xl' => '25px 0px 0px 10px', 'lg' => '', 'md' => '', 'sm' => '', 'xs' => ''],
				],
			],
			'depends' => [['is_second_button', '=', 1]]
		],
		...
		'second_btn_style' => [
			'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_STYLE'),
			'depends' => [['second_btn_type', '=', ''], ['is_second_button', '=', 1]],
			'fields' => [
				'second_btn_style_state' => [
					'type'   => 'radio',
					'values' => [
						'' => Text::_('Normal'),
						'hover' => Text::_('Hover'),
				...
				'second_btn_color' => [
					...
					'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'std' => '',
					'depends' => [['second_btn_style_state', '=', '']],
				],

				'second_btn_color_hover' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'std'     => '',
					'depends' => [['second_btn_style_state', '=', 'hover']],
				],

				'second_btn_background_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND_COLOR'),
					'std'     => '',
					'depends' => [
						['second_btn_style_state', '=', ''],
						['second_btn_appearance', '!=', 'gradient'],
					],
				],

				'second_btn_background_color_hover' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND_COLOR'),
					'std'     => '',
					'depends' => [
						['second_btn_style_state', '=', 'hover'],
						['second_btn_appearance', '!=', 'gradient'],
					],
				],

				'second_btn_background_gradient' => [
					'type' => 'gradient',
					'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND_COLOR'),
					'std' => [
						"color"  => "#3366FF",
				...
				'second_btn_background_gradient_hover' => [
					'type' => 'gradient',
					'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND_COLOR'),
					'std' => [
						"color"  => "#0037DD",
		...
		// Link type button
		'second_btn_link_type_style' => [
			'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_STYLE'),
			'depends' => [['second_btn_type', '=', 'link'], ['is_second_button', '=', 1]],
			'fields' => [
				'second_link_btn_style_state' => [
					'type'   => 'radio',
					'values' => [
						'' => Text::_('Normal'),
						'hover' => Text::_('Hover'),
				...
				'second_link_btn_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'depends' => [
						['second_link_btn_style_state', '=', ''],
						['second_btn_type', '=', 'link'],
					],
				],

				'second_link_btn_border_width' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BORDER_WIDTH'),
					'max'     => 30,
					'depends' => [
				...
				'second_link_btn_hover_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
					'std'     => '',
					'depends' => [
						['second_link_btn_style_state', '=', 'hover'],
						['second_btn_type', '=', 'link'],
					],
				],

				'second_link_btn_border_hover_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_BORDER_COLOR'),
					'std'     => '',
					'depends' => [
